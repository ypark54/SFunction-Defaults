...
MAKECMD         = /usr/local/MATLAB/R2020b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = default_model
MODULES                 = 
PRODUCT                 = default_model_sf.a
MAKEFILE                = default_model.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2020b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2020b
START_DIR               = /home/user/workspace/SFunction-Defaults/R2020b/x86_64-linux
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = GLNXA64
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2020b/bin/glnxa64" -lut -lfixedpoint
