...
MODEL                   = default_model
MODULES                 = default_model_sf.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/default_model_sf.mexa64
MAKEFILE                = default_model.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2023a
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2023a
START_DIR               = /home/user/workspace/SFunction-Defaults/R2023a/x86_64-linux
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               =  CREATEMODEL=0 USEPARAMVALUES=0 OPTS="-DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2023a/bin/glnxa64" -lut -lfixedpoint -lmx -lmex
...
MODELLIB                  = default_model_sf.mexa64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/default_model_sfcn_rtw \
...
default_model_sf.o : $(START_DIR)/default_model_sfcn_rtw/default_model_sf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/default_model_sfcn_rtw/default_model_sf.c

rtGetInf.o : $(START_DIR)/default_model_sfcn_rtw/rtGetInf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/default_model_sfcn_rtw/rtGetInf.c

rtGetNaN.o : $(START_DIR)/default_model_sfcn_rtw/rtGetNaN.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/default_model_sfcn_rtw/rtGetNaN.c
